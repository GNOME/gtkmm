...
Example_Panes::Example_Panes()
{
  ...
  pVBox->pack_start(*Gtk::make_managed<PaneOptions>(*pHPaned, "Horizontal", "Left", "Right"), Gtk::PACK_SHRINK);
  pVBox->pack_start(*Gtk::make_managed<PaneOptions>(*pVPaned, "Vertical", "Top", "Bottom"),   Gtk::PACK_SHRINK);
