...
!if [for %s in (..\demos\gtk-demo\*.cc) do @call create-lists.bat file gtkmm.mak ^$(CFG)\^$(PLAT)\gtkmm4-demo\%~ns.obj]
!endif
...
!if [for /f %d in ('dir /ad /b ..\tests\') do @call create-lists.bat file gtkmm.mak ^$(CFG)\^$(PLAT)\gtkmm4-test-%d.exe]
!endif
