...
install: all
	...
	@if not exist $(PREFIX)\share\gtkmm-$(GTKMM_API_VERSION)\proc\m4\ md $(PREFIX)\share\gtkmm-$(GTKMM_API_VERSION)\proc\m4
	...
	@copy ..\tools\m4\*.m4 $(PREFIX)\share\gtkmm-$(GTKMM_API_VERSION)\proc\m4
