...
install: all
	...
	@for %h in ($(GTKMM_HG_FILES)) do @if exist ..\gtk\gtkmm\%~nh.h copy ..\gtk\gtkmm\%~nh.h "$(PREFIX)\include\gtkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gtkmm\%~nh.h"
	@for %h in ($(GTKMM_HG_FILES)) do @if exist ..\untracked\gtk\gtkmm\%~nh.h copy ..\untracked\gtk\gtkmm\%~nh.h "$(PREFIX)\include\gtkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gtkmm\%~nh.h"
	@for %h in ($(GTKMM_HG_FILES)) do @if exist vs$(VSVER)\$(CFG)\$(PLAT)\gtkmm\%~nh.h copy vs$(VSVER)\$(CFG)\$(PLAT)\gtkmm\%~nh.h "$(PREFIX)\include\gtkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gtkmm\%~nh.h"
	...
	@for %h in ($(GTKMM_HG_FILES)) do @if exist ..\untracked\gtk\gtkmm\private\%~nh_p.h copy ..\untracked\gtk\gtkmm\private\%~nh_p.h "$(PREFIX)\include\gtkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gtkmm\private\%~nh_p.h"
