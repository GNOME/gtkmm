...
install: all
	...
	@for %h in ($(GDKMM_INT_GENERATED_HEADERS)) do @if exist vs$(VSVER)\$(CFG)\$(PLAT)\gdkmm\%h copy vs$(VSVER)\$(CFG)\$(PLAT)\gdkmm\%h "$(PREFIX)\include\gdkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gdkmm\%h"
	...
	@for %h in ($(GDKMM_INT_GENERATED_HEADERS_P)) do @if exist vs$(VSVER)\$(CFG)\$(PLAT)\gdkmm\private\%h copy vs$(VSVER)\$(CFG)\$(PLAT)\gdkmm\private\%h "$(PREFIX)\include\gdkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gdkmm\private\%h"
	...
	@for %h in ($(GTKMM_INT_GENERATED_HEADERS)) do @if exist vs$(VSVER)\$(CFG)\$(PLAT)\gtkmm\%h copy vs$(VSVER)\$(CFG)\$(PLAT)\gtkmm\%h "$(PREFIX)\include\gtkmm-$(GTKMM_MAJOR_VERSION).$(GTKMM_MINOR_VERSION)\gtkmm\%h"
