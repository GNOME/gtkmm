...
int main(int, char**)
{
  ...
  //Tell the server to do something that will eventually cause it to emit the  "something" signal.
  server.do_something(); //Client::on_server_something() will run before Server::do_something() has completed.
